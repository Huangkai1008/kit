...
import (
	...
	"github.com/Huangkai1008/kit/pkg/auth"
)
...
func (j *JwtAuth) CreateAccessToken(identity interface{}, fresh bool) (string, error) {
	...
	return tokenString, errors.Wrap(err, "Error")
}
...
var ProviderSet = wire.NewSet(wire.Bind(new(auth.Auth), new(*JwtAuth)), New, NewOptions)
